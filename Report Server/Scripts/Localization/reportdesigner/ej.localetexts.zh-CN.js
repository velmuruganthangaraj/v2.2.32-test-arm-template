ej.ReportDesigner.Locale['zh-CN'] = {
    ...
    chartProperty: {
        ...
        customAttribute: {
            ...
            userDefined: '用户自定义',
            alertHeader: '圖表報告項目',
            alertMessage: '自定义属性格式无效。 正确的例子：\'AttrName1 = Value1，AttrName2 = Value2 \'.'
        },
        chartArea: {
            categoryName: '图表区域',
            colorPalette: '调色板',
    ...
    dataField: {
        ...
        dsNameValidation: {
            nameWarning: '指定數據集名稱',
            nameAlert: '指定的名稱已存在於“數據集”列表中',
            nameValidation: '數據集名稱不應包含空格和特殊字符'
        }
    },
    dataPanel: {
        itemTooltip: {
    ...
    reportViewer: {
        ...
        alertMessage: {
            ...
            RVERR0009: '边距重叠，或者它们不在纸上。输入不同的边距大小。',
            RVERR0010: '请为参数输入一个值',
            RVERR0011: '该参数不能为空',
    ...
    designPanel: {
        ...
        pasteTitle: '糊',
        designAreaHeader: '设计区域标题',
        designAreaBody: '设计区主体',
        designAreaFooter: '设计区域页脚'
    },
    customProperty: {
        position: {
            categoryPosition: '位置',
    ...
    codeDialog: {
        ...
        classes: {
            ...
            headerText: '類實例列表',
            classTooltip: '添加類實例以訪問報表中的對象函數。'
        },
        code: {
            title: '码',
            headerText: '用於報告的VB代碼功能',
            codeTooltip: 'Syncfusion報告引擎支持VB代碼函數與報表元素和數據集成。'
        },
        customCode: '自定义代码编辑器',
