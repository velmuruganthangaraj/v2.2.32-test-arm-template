ej.ReportDesigner.Locale['es-ES'] = {
    itemPanel: {
        ...
        itemPanel: 'Artículo Panel Contenedor',
        customTooltip: {
            tooltip: {
                ...
                Items: {
                    ...
                    'textBox': {
                        ...
                        tooltip: {
                            ...
                            description: 'Muestra el texto estático y dinámico.',
                            title: 'Caja de texto'
                        }
                    },
                    'rectangle': {
            ...
            indication: {
                ...
                Items: {
                    ...
                    'indicator': {
                        ...
                        tooltip: {
                            requirements: '1 o más valores y 1 o más columnas.',
                            description: 'Muestra el informe del indicador.',
                            title: 'Indicador'
                        }
                    }
                }
    ...
    linkReport: {
        ...
        linkReport: 'Subinforme de enlace al elemento de informe',
    ...
    chartProperty: {
        ...
        axis: {
            ...
            tickProperties: {
                tickSize: 'Tamaño de la garrapata',
        ...
        gridLine: {
            ...
            gridLineStyle: {
                minorGridLine: 'Mostrar Minor Cuadricula',
                majorGridLineStyle: 'Estilo principal de Cuadricula',
                minorGridLineStyle: 'Estilo Menor de Cuadricula'
            }
        },
        pageBreak: {
    ...
    indicatorProperty: {
        ...
        indicatorStatesCategory: {
            indicatorStates: 'Estados indicadores',
            icon: 'Icono',
            color: 'Color',
            start: 'comienzo',
            end: 'Fin'
    ...
    browseFile: {
        ...
        browseReload: 'Examinar Recargar',
        browseContainer: 'Examinar contenedor de archivos'
    },
    expressionMenu: {
        reset: 'Reiniciar',
        expression: 'Expresión',
        advanced: 'Avanzado',
        expressionMenu: 'Menú de expresiones'
    },
    propertyPanel: {
    ...
    dataSource: {
        ...
        alertMessage: {
            ...
            alertConnectionFailed: 'El diseñador de informes no pudo conectar la fuente de datos',
            ...
            nameWarning: 'Especifique el nombre de la fuente de datos',
            nameAlert: 'El nombre especificado ya existe en la lista Fuente de datos',
            nameValidation: 'El nombre no debe contener espacios ni caracteres especiales'
        }
    },
    imageManager: {
    ...
    dataField: {
        ...
        dsNameValidation: {
            nameWarning: 'Especifique el nombre del conjunto de datos',
            nameAlert: 'El nombre especificado ya existe en la lista DataSet',
            nameValidation: 'El nombre de DataSet no debe contener espacios y caracteres especiales'
        }
    },
    dataPanel: {
        itemTooltip: {
    ...
    reportViewer: {
        toolbar: {
            ...
            pagesetup: {
                headerText: 'Configuración de página',
        ...
        alertMessage: {
            ...
            RVERR0008: 'Visor de informes no pudo validar las credenciales de Fuente de datos',
            ...
            RVERR0012: 'El valor proporcionado para el parámetro de informe {indicador de parámetros} no es válido para su tipo.'
        },
        reportItemLabel: {
    ...
    groupData: {
        grouping: 'Agrupamiento',
        headerTxt: 'Grupo',
        headerTxtLabel: 'Etiqueta de grupo',
        name: 'Nombre',
        label: 'Etiqueta',
    ...
    textBoxProperty: {
        ...
        interActiveSort: {
            ...
            userSort: {
                sortExpression: 'Ordenar expresión',
                sortExpressionScope: 'Ordenar alcance de expresión',
                sortTarget: 'Ordenar objetivo'
            }
        },
        textBoxLanguage: {
            categoryName: 'Idioma',
    ...
    designPanel: {
        ...
        pasteTitle: 'Pegar',
        designAreaHeader: 'Encabezado de área de diseño',
        designAreaBody: 'Área de diseño del cuerpo',
        designAreaFooter: 'Pie de área de diseño'
    },
    customProperty: {
        position: {
            categoryPosition: 'Posición',
    ...
    codeDialog: {
        ...
        classes: {
            ...
            classTooltip: 'Agregue instancias de clase para acceder a sus funciones de objeto en el informe.'
        },
        code: {
            title: 'Código',
            headerText: 'Función de código VB para informe',
            codeTooltip: 'El motor de informes Syncfusion admite funciones de código VB para integrarse con elementos y datos del informe.'
        },
    ...
    commonProperty: {
        ...
        visibility: {
            categoryVisibility: 'Visibilidad',
            visible: 'Visible'
        }
    }
};
