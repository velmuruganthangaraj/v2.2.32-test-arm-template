ej.ReportDesigner.Locale['en-US'] = {
    itemPanel: {
        ...
        itemPanel: 'Item Panel Container',
        customTooltip: {
            tooltip: {
                ...
                Items: {
                    ...
                    'textBox': {
                        ...
                        tooltip: {
                            ...
                            description: 'Displays the static and dynamic text.',
                            title: 'TextBox'
                        }
                    },
                    'rectangle': {
            ...
            indication: {
                ...
                Items: {
                    ...
                    'indicator': {
                        ...
                        tooltip: {
                            requirements: '1 or more values and 1 or more columns.',
                            description: 'Displays indicator report.',
                            title: 'Indicator'
                        }
                    }
                }
    ...
    linkReport: {
        ...
        linkReport: 'Link SubReport to the Report item',
    ...
    indicatorProperty: {
        ...
        indicatorStatesCategory: {
            indicatorStates: 'Indicator States',
            icon: 'Icon',
            color: 'Color',
            start: 'Start',
            end: 'End'
    ...
    browseFile: {
        ...
        browseContainer: 'Browse File Container'
    },
    expressionMenu: {
        reset: 'Reset',
    ...
    dataField: {
        ...
        dsNameValidation: {
            nameWarning: 'Specify the DataSet name',
            nameAlert: 'The specified name already exists in DataSet list',
            nameValidation: 'DataSet name should not contain spaces and special characters'
        }
    },
    dataPanel: {
        itemTooltip: {
    ...
    designPanel: {
        ...
        designAreaBody: 'Design Area Body',
    ...
    codeDialog: {
        ...
        classes: {
            ...
            classTooltip: 'Add class instances to access your object functions in report.'
        },
        code: {
            title: 'Code',
            headerText: 'VB code function for report',
            codeTooltip: 'Syncfusion reporting engine supports VB code functions to integrate with report element and data.'
        },
